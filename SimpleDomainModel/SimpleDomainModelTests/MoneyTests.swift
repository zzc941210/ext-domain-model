...
class MoneyTests: XCTestCase {
  ...
  func testAddUSDtoGBP() {
    ...
    func testDoubleMoney() {
        XCTAssert(15.USD.description == "USD15.0")
        XCTAssert(25.EUR.description == "EUR25.0")
        XCTAssert(30.GBP.description == "GBP30.0")
        XCTAssert(40.YEN.description == "YEN40.0")
    }
}
